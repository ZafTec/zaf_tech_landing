...
// Spruce accent in light vs dark modes — kept close to our CSS tokens.
const DARK_COLOR = [0.498, 0.812, 0.702];  // #7FCFB3
const LIGHT_COLOR = [0.188, 0.443, 0.373]; // ~spruce-700
...
export default function Threads({
  ...
  useEffect(() => {
    ...
    const initialColor = themeQuery.matches ? LIGHT_COLOR : DARK_COLOR;
    ...
    const onThemeChange = (e) => {
      const c = e.matches ? LIGHT_COLOR : DARK_COLOR;
      program.uniforms.uColor.value = new Color(...c);
    };
    ...
    // Pause animation when offscreen (perf)
    let visible = true;
    ...
    function update(t) {
      if (visible) {
        ...
        program.uniforms.iTime.value = reducedMotion ? 0 : t * 0.001;
